...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.cardview_page,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.book_page.setText(String.valueOf(book_pages.get(position)));
    }
...
//        System.out.println("size is "+book_id.size());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView book_id,book_title,book_author,book_page;
